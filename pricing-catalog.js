...
if (pricingData) {
  const currencyFormatter = new Intl.NumberFormat("pt-BR", {
    style: "currency",
    currency: pricingData.meta?.currency || "BRL",
  });
  ...
  if (
    ...
    const allItems = pricingData.items.map((item) => ({
      ...item,
    ...
    updateCategoryOptions();
    page.lastUpdated.textContent = new Date(pricingData.meta.sourceModifiedAt).toLocaleDateString("pt-BR");
